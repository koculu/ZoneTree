...
public class LockFreeSkipListIndexedReader<TKey, TValue> : IIndexedReader<TKey, TValue>
{
    ...
    public LockFreeSkipListIndexedReader(LockFreeSkipList<TKey, TValue> skipList)
    {
        SkipList = skipList;
